...
def startup():
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_TRUE, 7 * ctypes.sizeof(ctypes.c_float), ctypes.c_void_p(0))  # Pozycja
    glEnableVertexAttribArray(0)

    glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, 7 * ctypes.sizeof(ctypes.c_float),
